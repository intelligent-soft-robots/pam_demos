...
for dof in range(4):
    ...
    frontend.add_command(dof, p1, p2, o80.Duration_us.seconds(duration), o80.Mode.QUEUE)
    frontend.add_command(dof, p2, p1, o80.Duration_us.seconds(duration), o80.Mode.QUEUE)
