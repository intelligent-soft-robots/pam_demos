...
for iteration in range(5):
    ...
    # target position of robot2
    #pressures_ago = [12000,20000,16000,13000]
    #pressures_antago = [20000,12000,16000,18000]
    ...
    #robot2.add_command(pressures_ago,pressures_antago,
