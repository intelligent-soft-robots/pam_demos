...
for index in range(nb_balls):
    ball = pam_mujoco.MujocoItem(ball_segment_ids[index],
...
for iteration in range(5):
    ...
    for index_ball in range(nb_balls):
        ...
        balls.add_command(index_ball,item3d,o80.Duration_us.seconds(1),o80.Mode.QUEUE)
    ...
    robot.add_command(joints,joint_velocities,o80.Duration_us.seconds(2),o80.Mode.QUEUE)
    ...
    while True:
        ...
        for ball_index in range(nb_balls):
            ...
            if contact.contact_occured and not contact_detected[ball_index]:
                ...
                print(
                    "contact ball {} with racket at {}".format(ball_index,
                                                               contact.position)
                )
